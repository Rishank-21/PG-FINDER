...
const ExploreHotels = () => {
  ...
  const selectedStateObj = developedStates.find(
    (s) => s.state === stateFilter
  );
  const citiesForSelectedState = selectedStateObj
      ...
      <div className="filter-section bg-white shadow-md rounded-2xl p-4 md:p-6 max-w-6xl mx-auto mb-8">
        <div className="flex flex-col md:flex-row items-center gap-4 justify-between">
          ...
          <select
            ...
            className={`w-full md:w-1/4 border border-gray-300 rounded-full px-3 py-2 text-sm md:text-base outline-none ${
              !stateFilter ? "bg-gray-100 cursor-not-allowed" : ""
            }`}
          >
            <option value="">All Cities</option>
            {citiesForSelectedState.map((c, i) => (
